...
Future product lines after the shipped **v1.13.x — Dashboard UX**, **v1.14.x — Notifications**, **v1.15.x — Alert Rules**, **v1.16.x — Release Intelligence**, and **v1.17.x — Performance Intelligence** lines.
...
v1.15.x  Alert Rules                (shipped)
        ↓
v1.16.x  Release Intelligence       (shipped)
        ↓
v1.17.x  Performance Intelligence   (shipped)
        ↓
...
| [v1.16.x — Release Intelligence](https://github.com/Telemetry-Tracker/telemetry-tracker/milestone/19) | Release health + search | Shipped — #453, #494 |
| [v1.17.x — Performance Intelligence](https://github.com/Telemetry-Tracker/telemetry-tracker/milestone/20) | Compare + performance UX | Shipped — #495, #196, #197 |
...
Understand release health and find telemetry across releases, errors, events, and sessions. Releases page plus Global search (#453, #494).

### v1.17.x — Performance Intelligence (shipped)

Understand whether application health is improving or regressing over time. Compare periods, Performance / Web Vitals (including Overview card), and slow routes / pages (#495, #196, #197).
